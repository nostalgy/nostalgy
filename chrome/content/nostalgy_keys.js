var nostalgy_keys = [
  ...
  ["go", "Go to folder", "G", "JS:NostalgyGoCommand();"],
  [
    "go_suggest",
    "Go as suggested",
    "shift G",
  ...
  ["save_go", "Save message and go there", "B", "JS:NostalgySaveAndGo();"],
  [
    "save_go_suggest",
  ...
  ["hide_folders", "Hide folder pane", "L", "JS:NostalgyCollapseFolderPane();"],
  [
    "search_sender",
